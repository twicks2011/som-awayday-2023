...
**All elements (Exam 1 + Exam 2 + Coursework) must be passed in order to pass the module \- resits for each element instead of a single "supplementary resit" exam**
]
]

---
## New Assessments Demystified
